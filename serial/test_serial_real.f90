...
program test_serial_real
   ...
   ! Check A C - lambda C
   call dgemm("N","N",n_basis,n_states,n_basis,one,tmp,n_basis,evec,n_basis,&
        zero,mat,n_basis)
   ...
   call dlaset("U",n_states,n_states,zero,one,tmp,n_basis)
   call dsyrk("U","T",n_states,n_basis,-one,evec,n_basis,one,tmp,n_basis)
